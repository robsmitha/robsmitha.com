<template>
  ...
  >
    ...
    <v-app-bar-title class="text-h6 text-uppercase font-weight-medium">Rob Smitha</v-app-bar-title>
  ...
  >
    <v-list density="compact" nav>
      ...
      <v-list-item prepend-icon="mdi-code-braces" title="Projects" href="https://robsmitha.github.io/" target="_blank"></v-list-item>
