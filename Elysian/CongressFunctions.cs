...
namespace Elysian
{
    public class CongressFunctions(ILogger<CongressFunctions> logger, CapitolSharpCongress congressClient)
    {
        ...
        public async Task<IActionResult> GetBills([HttpTrigger(AuthorizationLevel.Anonymous, "get")] HttpRequestData req)
        {
        ...
        public async Task<IActionResult> GetBill([HttpTrigger(AuthorizationLevel.Anonymous, "get")] HttpRequestData req)
        {
        ...
        public async Task<IActionResult> CongressFeed([HttpTrigger(AuthorizationLevel.Anonymous, "get")] HttpRequestData req)
        {
            var offset = int.TryParse(req.Query["offset"], out var intOffset) ? intOffset : 0;
